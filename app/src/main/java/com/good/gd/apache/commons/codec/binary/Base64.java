...
public class Base64 implements BinaryEncoder, BinaryDecoder {
    ...
    public static byte[] encodeBase64(byte[] bArr, boolean z) {
        ...
        while (i5 < i3) {
            ...
            byte b4 = (byte) (b2 & 15);
            byte b5 = (byte) (b & 3);
            int i10 = b & ByteCompanionObject.MIN_VALUE;
            int i11 = b >> 2;
            if (i10 != 0) {
                i11 ^= 192;
            }
            byte b6 = (byte) i11;
            int i12 = b2 & ByteCompanionObject.MIN_VALUE;
            int i13 = b2 >> 4;
            if (i12 != 0) {
                i13 ^= 240;
            }
            ...
            bArr3[i6 + 2] = bArr4[(b4 << 2) | ((byte) i14)];
        ...
        if (i2 == 8) {
            byte b8 = bArr[i15];
            byte b9 = (byte) (b8 & 3);
            int i16 = b8 & ByteCompanionObject.MIN_VALUE;
            int i17 = b8 >> 2;
            if (i16 != 0) {
                i17 ^= 192;
            }
            byte[] bArr6 = lookUpBase64Alphabet;
            bArr3[i6] = bArr6[(byte) i17];
            bArr3[i6 + 1] = bArr6[b9 << 4];
            bArr3[i6 + 2] = PAD;
            bArr3[i6 + 3] = PAD;
        } else if (i2 == 16) {
            byte b10 = bArr[i15];
            ...
            bArr3[i6] = bArr7[b14];
            bArr3[i6 + 1] = bArr7[((byte) i21) | (b13 << 4)];
            bArr3[i6 + 2] = bArr7[b12 << 2];
            bArr3[i6 + 3] = PAD;
        }
        if (z && i7 < i) {
