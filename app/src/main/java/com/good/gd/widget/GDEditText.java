...
public class GDEditText extends EditText {
    ...
    public class hbfhc implements GDDLPWidgetUtil.aqdzk {
        ...
        public void dbjc(OnLongClickListener onLongClickListener) {
            GDEditText.this.setPrivateLongClickListenerImp(onLongClickListener);
        }
    }
    ...
    public void setPrivateLongClickListenerImp(OnLongClickListener onLongClickListener) {
    ...
    public void setEditActionEnabled(EditAction editAction, boolean z) {
        GDDLPWidgetUtil gDDLPWidgetUtil = this.gdDLPWidgetUtil;
        if (gDDLPWidgetUtil != null) {
            gDDLPWidgetUtil.dbjc(editAction, z);
        }
    }
    ...
    public GDEditText(Context context, AttributeSet attributeSet, int i, int i2) {
