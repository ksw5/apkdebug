...
import com.good.gd.internal.GDFileFactory;
...
public class File extends java.io.File {
    ...
    public static java.io.File createTempFile(String str, String str2) throws IOException {
        if (!GDSDKState.getInstance().isWiped()) {
            return FileImpl.createTempFile(str, str2, new GDFileFactory());
        }
    ...
    public static java.io.File[] listRoots() {
        ...
        return FileImpl.listRoots(new GDFileFactory());
    }
    ...
    public boolean equals(Object obj) {
        if (this._impl == null || GDSDKState.getInstance().isWiped() || !(obj instanceof File)) {
            return false;
        }
    ...
    public File(String str) {
        ...
        this._impl = new FileImpl<>(str, new GDFileFactory());
    }
    ...
    public static java.io.File createTempFile(String str, String str2, java.io.File file) throws IOException {
        if (!GDSDKState.getInstance().isWiped()) {
            return FileImpl.createTempFile(str, str2, file, new GDFileFactory());
        }
        throw new IOException(ErrorUtils.CONTAINER_WIPED_MSG);
    }
