...
public class AndroidMFingerprintAuthenticationHandler extends AbstractCommonAuthenticationHandler implements GDFingerprintAuthenticationHandler {

    /* loaded from: classes.dex */
    private abstract class fdyxd extends CryptoLogic implements AuthenticationCallback {
        public fdyxd(AndroidMFingerprintAuthenticationHandler androidMFingerprintAuthenticationHandler, GDFingerprintAuthenticationCallback gDFingerprintAuthenticationCallback) {
    ...
    class yfdke extends fdyxd {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        yfdke(AndroidMFingerprintAuthenticationHandler androidMFingerprintAuthenticationHandler, GDFingerprintAuthenticationCallback gDFingerprintAuthenticationCallback, byte[] bArr, byte[] bArr2, GDFingerprintAuthenticationCallback gDFingerprintAuthenticationCallback2) {
